...
$(document).ready(function () {
  ...
  function renderImages(containerId, totalImages, imagePath, altPrefix) {
    ...
    const prefix = altPrefix === "Produk Baru" ? "products-new-250530-" : "";
  ...
  renderImages("image-container-new", 61, "img/New/", "Produk Baru");
  renderImages(
    "image-container-frozen-food",
    230,
    "img/Frozenfood/",
    "Produk Frozen Food"
  );
  renderImages("image-container-snack", 108, "img/Snack/", "Produk Snack");
  renderImages(
    "image-container-bumbu-dapur",
    22,
    "img/Bumbu/",
    "Produk Bumbu Dapur"
  );
  renderImages("image-container-barang", 30, "img/Barang/", "Produk Barang");
